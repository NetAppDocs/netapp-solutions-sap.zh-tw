...
link:saphana_aff_nfs_sap_hana_installation_preparations_for_nfsv4.html["先前版本：NFSv4的SAP HANA安裝準備。"]
...
....
link:saphana_aff_nfs_sap_hana_data_volume_size.html["下一步：SAP HANA資料Volume大小。"]
