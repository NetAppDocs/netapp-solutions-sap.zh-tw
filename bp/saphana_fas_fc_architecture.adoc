...
image::saphana_fas_fc_image2.png[saphana FAS 光纖通道影像 2.]
...
image::saphana_fas_fc_image3.png[saphana FAS 光纖通道影像 3.]

SAP HANA環境獨立於已部署FAS 的整個系統儲存模式、也可藉由新增更多儲存控制器來擴充、如下圖所示。

image::saphana_fas_fc_image4.png[saphana FAS 光纖通道 Image4]
...
image::saphana_fas_fc_image5.jpg[saphana FAS 光纖通道影像 5.]
...
image::saphana_fas_fc_image6.png[saphana FAS 光纖通道影像 6.]
...
image::saphana_fas_fc_image7.png[saphana FAS 光纖通道影像 7.]
