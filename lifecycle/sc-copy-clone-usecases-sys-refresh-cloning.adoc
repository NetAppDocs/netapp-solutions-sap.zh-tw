...
邏輯損壞可能由軟體錯誤、人為錯誤或惡意破壞引起。遺憾的是，標準的高可用性和災難復原解決方案通常無法解決邏輯損壞問題。因此，根據邏輯損壞發生的層級、應用程式、檔案系統或儲存位置，有時可能無法滿足最大停機時間和資料遺失的要求。
...
https://www.netapp.com/pdf.html?item=/media/8584-tr4646pdf.pdf["SAP HANA災難恢復與儲存複寫"]

link:../backup/hana-dr-anf-data-protection-overview.html["使用 Azure NetApp Files 進行 SAP HANA 災難恢復"]
