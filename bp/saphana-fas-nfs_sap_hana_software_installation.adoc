...
link:saphana-fas-nfs_sap_hana_data_volume_size.html["先前版本：SAP HANA資料Volume大小。"]
...
link:saphana-fas-nfs_adding_additional_data_volume_partitions.html["下一步：新增額外的資料Volume分割區。"]
