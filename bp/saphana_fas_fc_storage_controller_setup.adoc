...
image::saphana_fas_fc_image12.png[saphana FAS 光纖通道影像 12.]
...
image::saphana_fas_fc_image13.jpg[saphana FAS 光纖通道影像 13.]
...
image::saphana_fas_fc_image14.jpeg[saphana FAS 光纖通道影像 14.]
...
image::saphana_fas_fc_image15.jpeg[saphana FAS 光纖通道影像 15.]
...
image::saphana_fas_fc_image16.jpeg[saphana FAS 光纖通道影像 16.]
...
image::saphana_fas_fc_image17.jpeg[saphana FAS 光纖通道影像 17.]
...
image::saphana_fas_fc_image18.jpg[saphana FAS 光纖通道影像 18.]
...
image::saphana_fas_fc_image19.jpg[saphana FAS 光纖通道影像]
...
+
image::saphana_fas_fc_image20.jpeg[saphana FAS 光纖通道影像 20]

. 輸入LUN名稱、選取LUN類型、然後輸入LUN的大小。
+
image::saphana_fas_fc_image21.jpeg[saphana FAS 光纖通道影像 21.]

. 輸入磁碟區名稱和託管Aggregate。
+
image::saphana_fas_fc_image22.jpeg[saphana FAS 光纖通道影像 22.]

. 選取LUN應對應的igroup。
+
image::saphana_fas_fc_image23.jpeg[saphana FAS 光纖通道影像]

. 提供QoS設定。
+
image::saphana_fas_fc_image24.jpeg[saphana FAS fc 影像 24]

. 按一下「摘要」頁面上的「下一步」。
+
image::saphana_fas_fc_image25.jpeg[saphana FAS 光纖通道影像]

. 按一下「完成」頁面上的「完成」。
+
image::saphana_fas_fc_image26.jpeg[saphana FAS 光纖通道影像 26.]
...
+
image::saphana_fas_fc_image27.jpeg[saphana FAS 光纖通道影像 27.]
