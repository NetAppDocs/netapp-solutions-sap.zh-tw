...
image:saphana_aff_nfs_image13.png["此圖顯示輸入 / 輸出對話方塊或表示寫入內容"]
...
image:saphana_aff_nfs_image14.jpg["此圖顯示輸入 / 輸出對話方塊或表示寫入內容"]
...
image:saphana_aff_nfs_image15.jpg["此圖顯示輸入 / 輸出對話方塊或表示寫入內容"]
...
image:saphana_aff_nfs_image16.jpg["此圖顯示輸入 / 輸出對話方塊或表示寫入內容"]
...
image:saphana_aff_nfs_image17.jpg["此圖顯示輸入 / 輸出對話方塊或表示寫入內容"]
