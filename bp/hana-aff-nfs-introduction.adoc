...
summary: NetApp AFF 支援系統產品系列已通過認證、可在量身打造的資料中心整合（TDI）專案中搭配SAP HANA使用。本指南提供了此平台上 SAP HANA 的最佳實務。 
---
...
[role="lead"]
NetApp AFF A 系列和 AFF C 系列產品已通過認證、可與 SAP HANA 搭配量身打造的資料中心整合（ TDI ）專案使用。本指南提供了此平台上適用於 NFS 的 SAP HANA 的最佳實務。
