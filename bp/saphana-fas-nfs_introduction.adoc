...
* FAS2720、FAS2750、FAS8300、FAS8700和FAS9000A完整的SAP HANA NetApp認證儲存解決方案清單、請參閱 https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=v:deCertified;ve:13["SAP HANA硬體目錄已通過認證且受到支援"^]。
