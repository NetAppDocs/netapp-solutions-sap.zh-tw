...
image::saphana-br-scs-image53.png[saphana br SCS 影像 53.]
...
image::saphana-br-scs-image54.png[saphana br SCS 影像 54]
...
image::saphana-br-scs-image55.png[saphana br SCS 版本 55]
...
+
image::saphana-br-scs-image56.png[saphana br SCS 版本 56]
...
+
image::saphana-br-scs-image57.png[saphana br SCS 影像 57]

.. 選取儲存系統（SVM）和磁碟區名稱所需的資料。
+
image::saphana-br-scs-image58.png[saphana br SCS 影像 58]
...
+
image::saphana-br-scs-image59.png[saphana br SCS 影像 59]
...
+
image::saphana-br-scs-image60.png[saphana br SCS 版本 60]
...
+
image::saphana-br-scs-image61.png[saphana br SCS 影像 61.]

. 確認指紋。
+
image::saphana-br-scs-image62.png[saphana br SCS 版本 62]

+
HANA外掛程式和Linux外掛程式的安裝會自動啟動。安裝完成後、主機的狀態欄會顯示為執行中。畫面也會顯示Linux外掛程式已與HANA外掛程式一起安裝。

+
image::saphana-br-scs-image63.png[saphana br SCS 影像 63.]
...
+
image::saphana-br-scs-image64.png[saphana br SCS 影像 64]

. 提供HANA資料庫的使用者存放區金鑰。
+
image::saphana-br-scs-image65.png[saphana br SCS 影像 65]
...
+
image::saphana-br-scs-image66.png[saphana br SCS 影像 66]

+
image::saphana-br-scs-image67.png[saphana br SCS 影像 67]
...
+
image::saphana-br-scs-image68.png[saphana br SCS 影像 68]



. 不需要在「應用程式設定」頁面上進行任何特定設定。按一下「下一步」
+
image::saphana-br-scs-image69.png[saphana br SCS 影像 69]

. 選取要新增至資源的原則。
+
image::saphana-br-scs-image70.png[saphana br SCS 版本 70]

. 定義「本地管理單元」原則的排程（在此範例中、每四小時一次）。
+
image::saphana-br-scs-image71.png[saphana br SCS 影像 71.]

. 定義LocalSnapAndSnapVault原則的排程（本範例中為每天一次）。
+
image::saphana-br-scs-image72.png[saphana br SCS 版本 72]

. 定義區塊完整性檢查原則的排程（在此範例中、每週一次）。
+
image::saphana-br-scs-image73.png[saphana br SCS 版本 73]

. 提供電子郵件通知的相關資訊。
+
image::saphana-br-scs-image74.png[saphana br SCS 版本 74]

. 在「摘要」頁面上、按一下「完成」。
+
image::saphana-br-scs-image75.png[saphana br SCS 版本 75]

. 現在可在拓撲頁面上建立隨需備份。排定的備份會根據組態設定執行。
+
image::saphana-br-scs-image76.png[saphana br SCS 版本 76]
...
image::saphana-br-scs-image77.png[saphana br SCS 版本 77]
