...
link:saphana_aff_fc_adding_additional_data_volume_partitions_for_sap_hana_single-host_systems.html["上一篇：為SAP HANA單一主機系統新增額外的資料Volume分割區。"]
...
link:saphana_aff_fc_update_history.html["下一步：更新歷程記錄。"]
