...
image::amazon-fsx-image9.png[Amazon FSX 影像 9.]
...
+
image::amazon-fsx-image10.png[Amazon FSX 影像 10.]

+
您可以選擇儲存系統類型ONTAP 、也可以是「SVM」或ONTAP 「叢集」。在下列範例中、已選取SVM管理。

+
image::amazon-fsx-image11.png[Amazon FSX 影像 11.]
...
+
image::amazon-fsx-image12.png[Amazon FSX 影像 12.]

. 若要設定儲存平台、請按一下「更多選項」。
. 選擇All Flash FAS 支援作為儲存系統、以確保FSX- for ONTAP the FSX-的授權可供SnapCenter 使用。
+
image::amazon-fsx-image13.png[Amazon FSX 影像 13.]

+
SVM的「sAPCA-Hana - SVM」現已設定SnapCenter 於SVM中。

+
image::amazon-fsx-image14.png[Amazon FSX 影像 14.]
...
+
image::amazon-fsx-image15.png[Amazon FSX 影像 15.]

. 在實驗室設定中、我們在SnapCenter HANA主機上設定了新的使用者「支援」、用於外掛部署。您必須啟用Sudo prvilleges、如下圖所示。
+
image::amazon-fsx-image16.png[Amazon FSX 影像 16.]
...
. 在主機索引標籤中、按一下新增。
+
image::amazon-fsx-image17.png[Amazon FSX 影像 17.]

. 提供主機資訊、並選取要安裝的SAP HANA外掛程式。按一下「提交」。
+
image::amazon-fsx-image18.png[Amazon FSX 影像 18.]

. 確認指紋。
+
image::amazon-fsx-image19.png[Amazon FSX 影像]
...
. 移至「設定」>「原則」、然後按一下「新增」。
+
image::amazon-fsx-image23.png[Amazon FSX 影像 23.]

. 輸入原則名稱和說明。按一下「下一步」
+
image::amazon-fsx-image24.png[Amazon FSX 影像 24]
...
+
image::amazon-fsx-image25.png[Amazon FSX 影像 25]

. 設定隨需備份的保留設定。
+
image::amazon-fsx-image26.png[Amazon FSX 影像 26.]

. 設定複寫選項。在這種情況下、未SnapVault 選取任何更新功能。
+
image::amazon-fsx-image27.png[Amazon FSX 影像 27.]

+
image::amazon-fsx-image28.png[Amazon FSX 影像 28]



現在已設定新原則。

image::amazon-fsx-image29.png[Amazon FSX 影像]
...
. 輸入原則名稱和說明。按一下「下一步」
+
image::amazon-fsx-image30.png[Amazon FSX 影像 30]

. 將備份類型設為「檔案型」、並將排程頻率設為「每週」。排程本身稍後會設定HANA資源保護組態。
+
image::amazon-fsx-image31.png[Amazon FSX 影像 31]

. 設定隨需備份的保留設定。
+
image::amazon-fsx-image32.png[Amazon FSX 影像 32.]

. 在「摘要」頁面上、按一下「完成」。
+
image::amazon-fsx-image33.png[Amazon FSX 影像 33.]

+
image::amazon-fsx-image34.png[Amazon FSX 影像 34]
...
+
image::amazon-fsx-image35.png[Amazon FSX 影像 35]

. 提供HANA資料庫的使用者存放區金鑰。
+
image::amazon-fsx-image36.png[Amazon FSX 影像 36.]

+
第二層自動探索程序會從探索租戶資料和儲存設備佔用空間資訊開始。

+
image::amazon-fsx-image37.png[Amazon FSX 影像 37]

. 在「Resources（資源）」索引標籤中、按兩下資源以設定資源保護。
+
image::amazon-fsx-image38.png[Amazon FSX 影像 38.]
...
+
image::amazon-fsx-image39.png[Amazon FSX 影像 39]

. 不需要在「應用程式設定」頁面上進行任何特定設定。按一下「下一步」
+
image::amazon-fsx-image40.png[Amazon FSX 影像 40]

. 選取要新增至資源的原則。
+
image::amazon-fsx-image41.png[Amazon FSX 影像 41.]
...
+
image::amazon-fsx-image42.png[Amazon FSX 影像 42.]
...
+
image::amazon-fsx-image43.png[Amazon FSX 影像 43.]

+
image::amazon-fsx-image44.png[Amazon FSX 影像 44]

. 提供電子郵件通知的相關資訊。
+
image::amazon-fsx-image45.png[Amazon FSX 影像 45]

+
image::amazon-fsx-image46.png[Amazon FSX 影像 46]



HANA資源組態現已完成、您可以執行備份。

image::amazon-fsx-image47.png[Amazon FSX 影像 47]
