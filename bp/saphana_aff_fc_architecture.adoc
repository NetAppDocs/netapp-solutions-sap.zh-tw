...
link:saphana_aff_fc_introduction.html["先前版本：TR-4436 -採用AFF Fibre Channel Protocol的NetApp穩定系統上的SAP HANA。"]
...
image:saphana_aff_fc_image5.jpg["錯誤：缺少圖形影像"]
...
如需SAP HANA備份與還原解決方案的詳細資訊、請參閱 https://www.netapp.com/us/media/tr-4614.pdf["TR-4614：SAP HANA備份與還原SnapCenter 功能（含功能）"^]。
...
image:saphana_aff_fc_image6.png["錯誤：缺少圖形影像"]
...
image:saphana_aff_fc_image7.png["錯誤：缺少圖形影像"]

link:saphana_aff_fc_storage_sizing.html["下一步：儲存規模調整。"]
