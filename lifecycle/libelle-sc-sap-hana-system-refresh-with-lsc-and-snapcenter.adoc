...
若要從來源資料庫執行自動Snapshot複本型備份、並為新的目標資料庫建立複本、LSC與SnapCenter Sfor之間所述的整合會使用中所述的組態選項和指令碼 https://www.netapp.com/pdf.html?item=/media/17111-tr4667pdf.pdf["TR-4667：利用SnapCenter 下列功能自動化SAP HANA系統複製與複製作業"^]。
...
* https://www.netapp.com/pdf.html?item=/media/17111-tr4667pdf.pdf["TR-4667：利用SnapCenter 下列功能自動化SAP HANA系統複製與複製作業"^]
