...
link:saphana_aff_nfs_sap_hana_software_installation.html["先前版本：SAP HANA軟體安裝。"]
...
link:saphana_aff_nfs_where_to_find_additional_information.html["下一步：何處可找到其他資訊。"]
