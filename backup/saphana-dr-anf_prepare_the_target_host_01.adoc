...
link:saphana-dr-anf_disaster_recovery_failover_overview.html["先前版本：災難恢復容錯移轉。"]
...
....
link:saphana-dr-anf_break_and_delete_replication_peering.html["下一步：中斷和刪除複寫對等關係。"]
