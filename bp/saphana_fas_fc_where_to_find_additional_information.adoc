...
link:saphana_fas_fc_adding_additional_data_volume_partitions_for_sap_hana_single-host_systems.html["上一篇：為SAP HANA單一主機系統新增額外的資料Volume分割區。"]
...
* TR-4646：SAP HANA災難恢復搭配使用SnapCenter NetApp HANA外掛程式的非同步儲存複寫
+
...
link:saphana_fas_fc_update_history.html["下一步：更新歷程記錄。"]
